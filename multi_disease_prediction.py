# -*- coding: utf-8 -*-
"""
Created on Sat Aug  2 16:45:23 2025
...
if (selected=='Diabetes Prediction') :
    ...
    #page title 
    st.title('Deiabetes Prediction using ML')
   # creating a function for Prediction
    ...
    if st.button('Diabetes Test Result'):
       ...
       # Reshape and predict
       diab_diagnosis = loaded_model_diabetic_disease.predict(input_data.reshape(1, -1))
...
if (selected=='Heart Disease Prediction') :
   ...
   # creating a button for Prediction
    ...
    if st.button('Heart Disease Test Result'): 
        heart_prediction = loaded_model_heart_disease.predict([[age, sex, cp, trestbps, chol, fbs, restecg,thalach,exang,oldpeak,slope,ca,thal]])                          
...
if (selected=='Parkinsons  Prediction') :
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_prediction = loaded_model_parkinsons_disease.predict([[fo, fhi, flo, Jitter_percent, Jitter_Abs, RAP, PPQ,DDP,Shimmer,Shimmer_dB,APQ3,APQ5,APQ,DDA,NHR,HNR,RPDE,DFA,spread1,spread2,D2,PPE]])                          
